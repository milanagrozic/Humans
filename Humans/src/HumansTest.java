...
public class HumansTest extends TestCase {
	...
	public void testPublicIntroduction() {
		...
		ConfusedNameHuman heywood = new ConfusedNameHuman(1990, 1, 1, "Heywood ", "Yapinchme", Gender.MALE);
		...
		ConfuseAgedHuman hugh = new ConfuseAgedHuman(1990, 1, 1, "Hugh ", "Jazz", Gender.MALE);
		System.out.println(introducer.createPublicIntroduction(hugh));
		assertEquals("This person has issues and can't be introduced.", introducer.createPublicIntroduction(hugh));
